...
case 'soc-follow-block':
    ...
    $iconSize = $attributes['iconSize'] ?? 'md'; // sm, md, lg
    $iconShape = $attributes['iconShape'] ?? 'rounded'; // square, rounded, circle
    $showLabels = !empty($attributes['showLabels']);
    
    // Size mapping
    $sizeMap = ['sm' => '24px', 'md' => '32px', 'lg' => '48px'];
    $btnSizeMap = ['sm' => 'btn-sm', 'md' => '', 'lg' => 'btn-lg'];
    $iconSizePx = $sizeMap[$iconSize] ?? '32px';
    
    $wrapper = get_block_wrapper_attributes([
        'class' => 'wpbb-soc-follow wpbb-soc-style-' . $style . ' wpbb-soc-shape-' . $iconShape . $extra
    ]);
    
    // SVG Icon sprite (inline for performance)
    $icons = [
        'facebook' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>',
        'instagram' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>',
        'linkedin' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>',
        'x' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',
        'youtube' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>',
        'whatsapp' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>',
        'tiktok' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>',
        'pinterest' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M12 0c-6.627 0-12 5.372-12 12 0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.098.119.112.224.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146 1.124.347 2.317.535 3.554.535 6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12z"/></svg>',
        'email' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M0 3v18h24v-18h-24zm21.518 2l-9.518 7.713-9.518-7.713h19.036zm-19.518 14v-11.817l10 8.104 10-8.104v11.817h-20z"/></svg>'
    ];
    
    $platforms = [
        'facebook' => ['url' => esc_url($attributes['facebook'] ?? ''), 'label' => 'Facebook'],
        'instagram' => ['url' => esc_url($attributes['instagram'] ?? ''), 'label' => 'Instagram'],
        'linkedin' => ['url' => esc_url($attributes['linkedin'] ?? ''), 'label' => 'LinkedIn'],
        'x' => ['url' => esc_url($attributes['x'] ?? ''), 'label' => 'X (Twitter)'],
        'youtube' => ['url' => esc_url($attributes['youtube'] ?? ''), 'label' => 'YouTube'],
        'tiktok' => ['url' => esc_url($attributes['tiktok'] ?? ''), 'label' => 'TikTok'],
        'pinterest' => ['url' => esc_url($attributes['pinterest'] ?? ''), 'label' => 'Pinterest'],
        'whatsapp' => ['url' => esc_url($attributes['whatsapp'] ?? ''), 'label' => 'WhatsApp'],
        'email' => ['url' => 'mailto:' . antispambot(sanitize_email($attributes['email'] ?? '')), 'label' => 'Email']
    ];
    
    $html = '';
    foreach ($platforms as $key => $data) {
        if (empty($data['url']) || $data['url'] === 'mailto:') continue;
        
        $icon = $icons[$key] ?? '';
        $label = $data['label'];
        
        if ($style === 'buttons') {
            $btnClass = 'btn btn-outline-primary ' . $btnSizeMap[$iconSize];
            if ($iconShape === 'circle') $btnClass .= ' rounded-circle';
            elseif ($iconShape === 'square') $btnClass .= ' rounded-0';
            
            $html .= '<a href="' . $data['url'] . '" class="' . $btnClass . ' d-inline-flex align-items-center gap-2" target="_blank" rel="noopener noreferrer" aria-label="' . $label . '">';
            $html .= $icon;
            if ($showLabels) $html .= '<span>' . $label . '</span>';
            $html .= '</a>';
        } elseif ($style === 'minimal') {
            $html .= '<a href="' . $data['url'] . '" class="wpbb-soc-minimal" target="_blank" rel="noopener noreferrer" aria-label="' . $label . '" style="color:' . ($attributes['iconColor'] ?? 'inherit') . '">';
            $html .= $icon;
            $html .= '</a>';
        } else {
            // Icons style (default)
            $bgColor = !empty($attributes['iconBgColor']) ? 'background:' . sanitize_hex_color($attributes['iconBgColor']) . ';' : '';
            $textColor = !empty($attributes['iconTextColor']) ? 'color:' . sanitize_hex_color($attributes['iconTextColor']) . ';' : '';
            $shapeClass = $iconShape === 'circle' ? 'rounded-circle' : ($iconShape === 'square' ? 'rounded-0' : 'rounded');
            
            $html .= '<a href="' . $data['url'] . '" class="wpbb-soc-icon-link ' . $shapeClass . '" target="_blank" rel="noopener noreferrer" aria-label="' . $label . '" style="' . $bgColor . $textColor . 'width:' . $iconSizePx . ';height:' . $iconSizePx . ';display:inline-flex;align-items:center;justify-content:center;text-decoration:none;">';
            $html .= $icon;
            $html .= '</a>';
        }
    }
    ...
    return '<div ' . $wrapper . '><' . $titleTag . ' class="wpbb-soc-title">' . $title . '</' . $titleTag . '><div class="wpbb-soc-links d-flex gap-2 flex-wrap">' . $html . '</div></div>';

case 'soc-share':
    $title = esc_html(wpbb_translate_string($attributes['title'] ?? __('Share', 'wp-bbuilder')));
    $titleTag = in_array(($attributes['titleTag'] ?? 'span'), ['h1','h2','h3','h4','h5','h6','div','p','span'], true) ? ($attributes['titleTag'] ?: 'span') : 'span';
    $style = $attributes['iconStyle'] ?? 'icons';
    $iconSize = $attributes['iconSize'] ?? 'md';
    $iconShape = $attributes['iconShape'] ?? 'rounded';
    
    $sizeMap = ['sm' => '20px', 'md' => '24px', 'lg' => '32px'];
    $iconSizePx = $sizeMap[$iconSize] ?? '24px';
    ...
    $shares = [
        'facebook' => [
            ...
            'icon' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>'
        ],
        'twitter' => [
            'url' => 'https://twitter.com/intent/tweet?url=' . $shareUrl . '&text=' . $shareTitle,
            'label' => 'Share on X',
            'icon' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>'
        ],
        'linkedin' => [
            'url' => 'https://www.linkedin.com/sharing/share-offsite/?url=' . $shareUrl,
            'label' => 'Share on LinkedIn',
            'icon' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>'
        ],
        'pinterest' => [
            'url' => 'https://pinterest.com/pin/create/button/?url=' . $shareUrl . '&description=' . $shareTitle,
            'label' => 'Pin on Pinterest',
            'icon' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M12 0c-6.627 0-12 5.372-12 12 0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.098.119.112.224.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146 1.124.347 2.317.535 3.554.535 6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12z"/></svg>'
        ],
        'email' => [
            'url' => 'mailto:?subject=' . $shareTitle . '&body=' . $shareUrl,
            'label' => 'Share via Email',
            'icon' => '<svg viewBox="0 0 24 24" width="' . $iconSizePx . '" height="' . $iconSizePx . '" fill="currentColor"><path d="M0 3v18h24v-18h-24zm21.518 2l-9.518 7.713-9.518-7.713h19.036zm-19.518 14v-11.817l10 8.104 10-8.104v11.817h-20z"/></svg>'
        ]
    ];
    ...
    foreach ($shares as $key => $data) {
        ...
        if ($style === 'buttons') {
            $html .= '<a href="' . $data['url'] . '" class="btn btn-outline-secondary btn-sm ' . $shapeClass . '" target="_blank" rel="noopener noreferrer" aria-label="' . $data['label'] . '" onclick="window.open(this.href,\'share\',\'width=600,height=400\');return false;">';
            $html .= $data['icon'] . ' <span class="ms-1">' . ucfirst($key) . '</span>';
            $html .= '</a>';
        } else {
            $bgStyle = !empty($attributes['iconBgColor']) ? 'background:' . sanitize_hex_color($attributes['iconBgColor']) . ';' : '';
            $colorStyle = !empty($attributes['iconColor']) ? 'color:' . sanitize_hex_color($attributes['iconColor']) . ';' : '';
            
            $html .= '<a href="' . $data['url'] . '" class="wpbb-share-link ' . $shapeClass . '" target="_blank" rel="noopener noreferrer" aria-label="' . $data['label'] . '" style="' . $bgStyle . $colorStyle . 'width:' . $iconSizePx . ';height:' . $iconSizePx . ';display:inline-flex;align-items:center;justify-content:center;" onclick="window.open(this.href,\'share\',\'width=600,height=400\');return false;">';
            $html .= $data['icon'];
            $html .= '</a>';
        }
    }
    
    return '<div ' . $wrapper . '><' . $titleTag . ' class="wpbb-share-title me-2">' . $title . '</' . $titleTag . '><div class="wpbb-share-links d-inline-flex gap-2">' . $html . '</div></div>';
